...
#ifndef __CONFIG_HELAN2_DKB_H
#define __CONFIG_HELAN2_DKB_H
...
#define CONFIG_MACH_HELAN2_DKB		1	/* Machine type */
...
#define CONFIG_BOOTARGS			\
			...
			" console=ttyS1,115200 panic_debug uart_dma user_debug=31" \
