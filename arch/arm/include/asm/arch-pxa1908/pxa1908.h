...
#define APBC_POWER		(1<<7)  /* Power Enable */
...
#define PXA1908_DRAM_BASE	0xC0100000
#define PXA1908_KPC_BASE		0xD4012000
#define PXA1908_TMR1_BASE	0xD4014000
#define PXA1908_APBC_BASE	0xD4015000
#define PXA1908_UART0_BASE	0xD4036000
#define PXA1908_UART1_BASE	0xD4017000
#define PXA1908_MPMU_BASE	0xD4050000
#define PXA1908_GEN_CNT_BASE	0xD4101000
#define PXA1908_APMU_BASE	0xD4282800
#define PXA1908_CIU_BASE		0xD4282C00
#define PXA1908_MFPR_BASE	0xD401E000
#define PXA1908_GPIO_BASE	0xD4019000
#define PXA1908_APBCP_BASE	0xD403B000
#define PXA1908_SQU_BASE		0xD42A0000

#define BOOT_ROM_VER		0xFFE00028
#define RTC_CLK			0xD4015028
#define RTC_BRN0		0xD4010014
#define FB_MAGIC_NUM		('f'<<24 | 'a'<<16 | 's'<<8 | 't')
#define FB_MAGIC_NUM_ALT	('b'<<24 | 'o'<<16 | 'o'<<8 | 't')
#define PD_MAGIC_NUM		('p'<<24 | 'r'<<16 | 'o'<<8 | 'd')

/* Register offset */
#define PXA1908_APBC_KEYPAD (PXA1908_APBC_BASE+0x50)

#define KPC_PC (PXA1908_KPC_BASE+0x00)
#define KPC_DK (PXA1908_KPC_BASE+0x08)
#define KPC_AS (PXA1908_KPC_BASE+0x20)
#define KPC_ASMKP0 (PXA1908_KPC_BASE+0x28)
#define KPC_ASMKP1 (PXA1908_KPC_BASE+0x30)
#define KPC_ASMKP2 (PXA1908_KPC_BASE+0x38)

#define APMU_DEBUG	(PXA1908_APMU_BASE+0x88)
#define APMU_GC		(PXA1908_APMU_BASE+0xcc)
#define APMU_GC_2D	(PXA1908_APMU_BASE+0xf4)
#define APMU_PWR_BLK_TMR_REG    (PXA1908_APMU_BASE+0xdc)
#define APMU_PWR_CTRL_REG       (PXA1908_APMU_BASE+0xd8)
#define APMU_PWR_STATUS_REG     (PXA1908_APMU_BASE+0xf0)
#define APMU_VPU_CLK_RES_CTRL	(PXA1908_APMU_BASE+0xa4)

/* SQU debug register for 1u88 */
#define FABTIMEOUT_HELD_WSTATUS	(PXA1908_SQU_BASE + 0x78)
#define FABTIMEOUT_HELD_RSTATUS	(PXA1908_SQU_BASE + 0x80)
#define DVC_HELD_STATUS		(PXA1908_SQU_BASE + 0xB8)
#define FCDONE_HELD_STATUS	(PXA1908_SQU_BASE + 0xC0)
#define PMULPM_HELD_STATUS	(PXA1908_SQU_BASE + 0xC8)
#define CORELPM_HELD_STATUS	(PXA1908_SQU_BASE + 0x100)
#define PLL_HELD_STATUS		(PXA1908_SQU_BASE + 0x108)
/* APSR to check WDT reset */
#define MPMU_APSR		(PXA1908_MPMU_BASE + 0x1028)

/* MCK QoS control */
#define MC_QOS_CTRL		(PXA1908_CIU_BASE + 0x1C)
...
#define APBC_COUNTER_CLK_SEL		(PXA1908_APBC_BASE + 0x64)
#define CNT_FREQ_HW_CTRL		(0x1 << 0)
#define CNT_LOW_FREQ_STEP_SHIFT		16

/* for arch timer */
#define CNTCR_REG		(PXA1908_GEN_CNT_BASE + 0x00)
#define CNTCR_EN		(0x1 << 0)
#define CNTCR_HDBG		(0x1 << 1)

#define GICD_BASE 0xd1df9000
#define GICC_BASE 0xd1dfa000
