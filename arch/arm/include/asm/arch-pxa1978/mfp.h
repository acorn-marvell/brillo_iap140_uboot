...
#ifndef __PXA1978_MFP_H
#define __PXA1978_MFP_H

/*
 * Frequently used MFP Configuration macros for all PXA1978 family of SoCs
 *
 * offset, pull,pF, drv,dF, edge,eF ,afn,aF
 */

/* TODO: update these per 1978 pinmux */
