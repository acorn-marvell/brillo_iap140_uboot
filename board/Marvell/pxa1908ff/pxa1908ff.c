...
/* 1 - 533Mhz, 2 -- 667Mhz */
static void pxa1908ff_get_ddr_mode(void)
{
...
/*
 * pxa1908ff uses direct key dk_pin1 and dk_pin2
 * So the param of pxa1908ff_key_detect should be
 * 1 or 2. For example, pxa1908ff_key_detect(1);
 */
static int __attribute__ ((unused)) pxa1908ff_key_detect(int dk_pin)
{
	u32 kpc_dk;
	udelay(500);
...
static void __attribute__ ((unused)) pxa1908ff_keypad_init(void)
{
...
{
	printf("pxa1908ff board rebooting...\n");
...
static struct dsi_info pxa1908ff_720p_dsi = {
	.id = 1,
	.lanes = 4,
	.bpp = 24,
...
static struct dsi_info pxa1908ff_fwvga_dsi = {
	.id = 1,
	.lanes = 2,
	.bpp = 24,
	.burst_mode = DSI_BURST_MODE_BURST,
...
void set_fl10802_info(struct mmp_disp_plat_info *fb)
{
	...
	fb->phy_info = &pxa1908ff_fwvga_dsi;
...
static unsigned char pxa1908ff_recovery_reg_read(void)
{
	u32 value = 0;
...
static unsigned char pxa1908ff_recovery_reg_write(unsigned char value)
{
	struct pmic *pmic_base;
...
static struct recovery_reg_funcs pxa1908ff_recovery_reg_funcs = {
	.recovery_reg_read = pxa1908ff_recovery_reg_read,
	.recovery_reg_write = pxa1908ff_recovery_reg_write,
};
...
int misc_init_r(void)
{
	...
	if (!fastboot)
		show_logo();
#endif
	p_recovery_reg_funcs = &pxa1908ff_recovery_reg_funcs;
