...
static int do_env_resetsave(cmd_tbl_t *cmdtp, int flag, int argc,
		       char * const argv[])
{
	printf("Reset and saving Environment to %s...\n", env_name_spec);
...
U_BOOT_CMD(
	envresetsave, 1, 0,	do_env_resetsave,
	"reset and save environment variables to persistent storage",
	""
);
#endif
#endif /* CONFIG_SPL_BUILD */
